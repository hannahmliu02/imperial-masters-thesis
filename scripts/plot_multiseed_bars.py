...
def main(argv=None) -> int:
    ...
    # presence/anchor values are reported in the presence+retention table
    # (docs/mistral_presence_table.tex), not plotted here.

    fig, (axa, axb) = plt.subplots(2, 1, figsize=(7.0, 9.5))
